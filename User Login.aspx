<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User Login.aspx.cs" Inherits="Online_Cosmetics_Shop.User_Login" %>
...
<html lang="en">
   ...
   <body>
      ...
      <strong> <h1 align="center"><b>User Login</b></h1></strong>
    ...
    <div>
     <div class="container"><div class="row"><div class="col-md-12">
        ...
        <br />
        <br />
        <asp:TextBox ID="txt_pass" runat="server" TextMode="Password" CssClass="form-control" placeholder="Password"></asp:TextBox>
        <br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_login" runat="server" OnClick="btn_login_Click" Text="LogIn" CssClass="btn-dark" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Customer.aspx" >Register Here</asp:HyperLink>
       </div></div></div>
    </div>
    </form>
