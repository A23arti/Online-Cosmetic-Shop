<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Brand_Master.aspx.cs" Inherits="Online_Cosmetics_Shop.WebForm1" %>
...
<html lang="en">
   <head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function formValidator(){
            ...
            var brand_nm= document.getElementById("txt_bnm");

            // Check each input in the order that it appears in the form!
           // if(notEmpty(Brand_id,"ID Must be given") && isAlphabet(name, "Please enter only letters for your name"))
            //{
                if(notEmpty(brand_nm ,"Name Must be given") && isAlphabet(brand_nm, " Letters Only for Name")){
   ...
   <body>
      ...
      <!-- contact section start -->
       <br />
        <br /> <br /> <br /> 
      <strong> <h1 align="center"><b>Brand Master</b></h1></strong>
    ...
    <div>
     <div class="container"><div class="row"><div class="col-md-12">
        ...
        <asp:TextBox ID="txt_bid" CssClass="form-control" placeholder="Id" runat="server" Enabled="False"></asp:TextBox>
        <br />

        <asp:TextBox ID="txt_bnm" CssClass="form-control" placeholder="Name" runat="server" Enabled="False"></asp:TextBox>
        <br />
         <asp:FileUpload ID="FileUpload1" runat="server" /><asp:Button ID="Button1" runat="server"  CssClass="btn-dark"  Text="Upload" OnClick="Button1_Click" />
...
&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_save" runat="server" Enabled="False" OnClick="btn_save_Click" Text="Save"  CssClass="btn-dark" OnClientClick="return formValidator()" />
&nbsp;&nbsp;&nbsp;
